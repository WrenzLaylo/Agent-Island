    ...
    <div className="settings-view">
      ...
      <div className="settings-scroll">
        ...
        <section className="settings-group">
          ...
          <label className="setting-slider">
            <span><strong>Glass intensity</strong><small>{Math.round(settings.glassIntensity * 100)}%</small></span>
            <input
              type="range"
              min="0.45"
              max="0.92"
              ...
              data-no-drag="true"
              onChange={(event: { target: { value: string } }) => onChange({ glassIntensity: Number(event.target.value) })}
            />
          </label>
          <label className="setting-row">
